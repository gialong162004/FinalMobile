...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public ProductAdapter(List<Product> products, Context context, boolean isGuest) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (user == null) {
            // Guest
            holder.addBtn.setAlpha(0.5f); // Mờ đi
            holder.addBtn.setEnabled(false); // Không bấm được
        } else {
            holder.addBtn.setAlpha(1f);
